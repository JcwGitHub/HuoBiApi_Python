...
//	}
	...
	if (Json.ParseFile("C:\\HuoBiKey.json"))
	{
		Json.Get("Secret_Key", god.Secret_Key);
		Json.Get("Access_Key", god.Access_Key);
	}
	...
	CString tmp = god.Post_place("eosusdt", "55", "0.11", "api", "sell-limit");
