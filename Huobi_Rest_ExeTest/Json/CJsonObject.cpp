...
bool CJsonObject::ParseFile(const std::string& FilePath)
{
...
bool CJsonObject::Wirte2File(const std::string& FilePath)
{
	bool Success = false;
...
bool CJsonObject::ExitKey(const std::string& strKey)
{
...
bool CJsonObject::Get(const std::string& strKey, CString& strValue) const
{
	cJSON* pJsonStruct = NULL;
	if (m_pJsonData != NULL)
	{
